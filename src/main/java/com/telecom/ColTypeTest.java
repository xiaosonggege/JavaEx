...
import com.telecom.singleTable.CheckColumnNullType;
...
public class ColTypeTest {
    public static void main( String[] args ) {
        //判断字段字符串长度是否满足要求
        //导入yaml配置信息
        final String file_path = "/Users/songyunlong/Desktop/DataCheck/src/main/java/com/telecom/requirementConfig/col_type_test_config.yaml";
        ...
        try{
            check_col_type.call(structType, data_source, need_check_col_name);
        } catch (Exception e){
            e.printStackTrace();
        }
